...
def NotifyMachineDataTransfer(sourceMachine, machineToCopy, nameOfFile):
	...
	srcPort = 6000          # port to send to the src the req type  # will change to see which is available
	...
	dic2={"requestType":"replicate", "type":'dst', "port":port}
	dk = 'dataKeeper'
	...
	socket.bind("tcp://127.0.0.1:%s" % srcPort)
