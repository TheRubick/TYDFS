...
if(operationType == "upload"):
    ...
    request = {"requestType":"download", "arg" : "newtest1.mp4"} # send the master the type of service i need plus the file i need to download in case of download
